	...
	return (
		...
		>
			<div className="w-8/12 mx-auto">
				<h4 className="text-white text-3xl w-full text-center">"Розкрийте силу моментів - Ваша історія, Наш об'єктив"</h4>
				<div className="bg-white/90 rounded-2xl w-full p-3 mt-5 text-gray font-normal text-xl">
					...
					<input
						...
						value={searchText}
						className="border-none outline-none bg-transparent w-10/12"
					/>
				</div>
				<div className="mt-2 ">
